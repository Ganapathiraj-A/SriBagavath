...
gh release create $TAG "$APK_NAME" --title "v2.8.86: Offline Transactions Mode" --notes "Added Offline Transactions Mode for donations, registrations, and bookstore. Controlled via Admin Settings."
