                            ...
                            {!showSubscriptionOptions ? (
                                ...
                                >
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                                        <h3 style={{ margin: 0, fontSize: '1.125rem', fontWeight: 700 }}>Select Subscription</h3>
                                        <button
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                        ...
                                        >
                                            <span style={{ fontWeight: 600 }}>5 Year Subscription</span>
                                            <span style={{ fontWeight: 800, color: 'var(--color-primary)' }}>₹500</span>
                                        </button>
                                        <button
                                        ...
                                        >
                                            <span style={{ fontWeight: 600 }}>Lifetime Subscription</span>
                                            <span style={{ fontWeight: 800, color: 'var(--color-primary)' }}>₹1000</span>
                                        </button>
                                    </div>
                                </motion.div>
                            )}
