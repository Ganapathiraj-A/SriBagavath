...
export const GlobalSettingsProvider = ({ children }) => {
    ...
    const [publicSettings, setPublicSettings] = useState({
        ...
        driveHindiBooksId: '1th9WKd0K8OwMx-gC8B8_OZQkMaTpiar4',
        driveTeluguBooksId: '1z8X8QiAI8B9LjUeLUqhjgoWTMwuTSAq1',
        ...
        driveKannadaBooksId: '',
        driveRussianBooksId: '1NKWcCGzcWXYnJWj0nStaLHps3OVBXLXv',
        driveHebrewBooksId: '105YZMDLi5cGFZ7xL5PT8N_p7PZWfzPH7',
        driveSpanishBooksId: '1gbFJp3RoPpwRlwciDbxoemDOAZtjRWka',
        driveGermanBooksId: '1YAEZZeKhUhjr95yLGibcWsoRpcSsSjuc',
        driveItalianBooksId: '1z8tKsPfVWMtEoCi-BL_utILcLC9yyEcq',
    ...
    return (
        <GlobalSettingsContext.Provider value={{
            ...
            driveHindiBooksId: publicSettings.driveHindiBooksId,
            driveTeluguBooksId: publicSettings.driveTeluguBooksId,
            driveMagazineId: publicSettings.driveMagazineId,
            driveAudioBooksId: publicSettings.driveAudioBooksId,
            driveMalayalamBooksId: publicSettings.driveMalayalamBooksId,
            driveKannadaBooksId: publicSettings.driveKannadaBooksId,
            driveRussianBooksId: publicSettings.driveRussianBooksId,
            driveHebrewBooksId: publicSettings.driveHebrewBooksId,
            driveSpanishBooksId: publicSettings.driveSpanishBooksId,
            driveGermanBooksId: publicSettings.driveGermanBooksId,
            driveItalianBooksId: publicSettings.driveItalianBooksId,
            ...
            setDriveHindiBooksId: (val) => updatePublic({ driveHindiBooksId: val }),
            setDriveTeluguBooksId: (val) => updatePublic({ driveTeluguBooksId: val }),
            setDriveMagazineId: (val) => updatePublic({ driveMagazineId: val }),
            setDriveAudioBooksId: (val) => updatePublic({ driveAudioBooksId: val }),
            setDriveMalayalamBooksId: (val) => updatePublic({ driveMalayalamBooksId: val }),
            setDriveKannadaBooksId: (val) => updatePublic({ driveKannadaBooksId: val }),
            setDriveRussianBooksId: (val) => updatePublic({ driveRussianBooksId: val }),
            setDriveHebrewBooksId: (val) => updatePublic({ driveHebrewBooksId: val }),
            setDriveSpanishBooksId: (val) => updatePublic({ driveSpanishBooksId: val }),
            setDriveGermanBooksId: (val) => updatePublic({ driveGermanBooksId: val }),
            setDriveItalianBooksId: (val) => updatePublic({ driveItalianBooksId: val }),
